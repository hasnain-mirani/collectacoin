...
const AutographPage = () => {
  ...
  const router = useRouter();
    ...
    return (
        <Box sx={{padding: 1.5, backgroundColor: "#fff"}}>
          <Box>
          <Box sx={{margin: 0.5}}>
                <Box>
                   {/* mapped elements */}
                   <Box sx={{height: "7rem", width: "100%", backgroundColor: '#EEECF9', borderRadius: "20px", display: "flex", flexDirection: "row"}}>
                    <Image src="https://picsum.photos/200" alt="image"              
                        width={0}
                      height={0}
                      sizes="100vw"
                      style={{ width: '37%', height: '100%', borderRadius: "20px" }} onClick={()=> router.push("dashboard/autographs/1")} />
                      <Box sx={{width: "63%", display:"flex", flexDirection: "row", justifyContent: "space-between" }}>
                        <Box sx={{marginLeft: 2, display: "flex", flexDirection: "column", justifyContent: "flex-start", paddingTop: 2}}>
                          <Typography sx={{fontWeight: "bold"}} onClick={()=> router.push("dashboard/autographs/1")}>The Weekend</Typography>
                          <Typography sx={{color: '#595959'}}>Canadian Singer</Typography>
                        </Box>
                        <Box sx={{display: "flex", flexDirection: "column", justifyContent: "flex-end", marginX: 1, marginY: 1}}>
                   ...
                   <Box sx={{height: "7rem", width: "100%", marginY: 2, backgroundColor: '#EEECF9', borderRadius: "20px", display: "flex", flexDirection: "row"}}>
                    <Image src="https://picsum.photos/200" alt="image"              
                        width={0}
                      height={0}
                      sizes="100vw"
                      ...
                      <Box sx={{width: "63%", display:"flex", flexDirection: "row", justifyContent: "space-between" }}>
                        <Box sx={{marginLeft: 2, display: "flex", flexDirection: "column", justifyContent: "flex-start", paddingTop: 2}}>
                          <Typography sx={{fontWeight: "bold"}} onClick={()=> router.push("dashboard/autographs/1")}>Justin Beiber</Typography>
                          <Typography sx={{color: '#595959', fontSize: 15}}>Canadian Singer</Typography>
                        </Box>
                        <Box sx={{display: "flex", flexDirection: "column", justifyContent: "flex-end", marginX: 1, marginY: 1}}>
                           <Typography  sx={{color: '#595959'}}>Time</Typography>
                           <Typography  sx={{color: '#523FAD', fontSize: 12}}>17:30 - 18:00</Typography>
                  ...
                  <Box>
                   ...
                   <Box sx={{height: "7rem", width: "100%", marginY: 2, backgroundColor: '#EEECF9', borderRadius: "20px", display: "flex", flexDirection: "row"}}>
                    <Image src="https://picsum.photos/200" alt="image"              
                      ...
                      <Box sx={{width: "63%", display:"flex", flexDirection: "row", justifyContent: "space-between" }}>
                        <Box sx={{marginLeft: 2, display: "flex", flexDirection: "column", justifyContent: "flex-start", paddingTop: 2}}>
                          <Typography sx={{fontWeight: "bold"}} onClick={()=> router.push("dashboard/autographs/1")}>Chris Brown</Typography>
                          <Typography sx={{color: '#595959'}}>American Singer Song Writer</Typography>
                        </Box>
                        <Box sx={{display: "flex", flexDirection: "column", justifyContent: "flex-end", marginX: 1, marginY: 1}}>
                           <Typography  sx={{color: '#595959'}}>Time</Typography>
                           <Typography  sx={{color: '#523FAD', fontSize: 12}}>17:30 - 18:00</Typography>
                   ...
                   <Box sx={{height: "7rem", width: "100%", marginY: 2, backgroundColor: '#EEECF9', borderRadius: "20px", display: "flex", flexDirection: "row"}}>
                    <Image src="https://picsum.photos/200" alt="image"              
                      ...
                      <Box sx={{width: "63%", display:"flex", flexDirection: "row", justifyContent: "space-between" }}>
                        <Box sx={{marginLeft: 2, display: "flex", flexDirection: "column", justifyContent: "flex-start", paddingTop: 2}}>
                          <Typography sx={{fontWeight: "bold"}} onClick={()=> router.push("dashboard/autographs/1")}>Dua Lipa</Typography>
                          <Typography sx={{color: '#595959'}}>Albanian Singer</Typography>
                        </Box>
                        <Box sx={{display: "flex", flexDirection: "column", justifyContent: "flex-end", marginX: 1, marginY: 1}}>
                           <Typography  sx={{color: '#595959'}}>Time</Typography>
                           <Typography  sx={{color: '#523FAD', fontSize: 12}}>17:30 - 18:00</Typography>
